...
#'
#+ svm_all_fit_full_bookmark, include = FALSE
# svm_all_fit_full ####
...
#'
#+ svm_select_tune_bookmark, include = FALSE
# svm_select_tune ####
...
#'
#+ model_all_fit_full_compare, eval = FALSE
# do this for select?
...
#'
#' I'data like to also compare the confusion matrices
